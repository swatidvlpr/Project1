<%@ Page Title="" Language="C#" MasterPageFile="~/DSR/DSR.master" AutoEventWireup="true" CodeFile="Nextmonthplanning.aspx.cs" Inherits="DSR_Nextmonthplanning" %>
...
<div class="main-page">
    <div id="form1" class="forms validation">
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            <div class="form-title">
							<h4>NEXT MONTH PLANNING (PROSPECTS IN HAND) :</h4>
						</div>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ErrorMessage="Select model name" ControlToValidate="ddlmodel" ValidationGroup="a" InitialValue="0"></asp:RequiredFieldValidator>
                  ...
                  <div class="col-md-6 form-group">
                     <label >Hot :</label> 
                      <asp:TextBox ID="txthot" runat="server" CssClass="form-control" OnTextChanged="txthot_TextChanged" AutoPostBack="True">0</asp:TextBox>
                        <cc1:FilteredTextBoxExtender ID="txthot_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txthot">
                      </cc1:FilteredTextBoxExtender>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  
                          ErrorMessage="Enter hot" ControlToValidate="txthot" ValidationGroup="a" ></asp:RequiredFieldValidator>
                 </div>
                 <div class="col-md-6 form-group">
                    <label >Warm :</label>                      
