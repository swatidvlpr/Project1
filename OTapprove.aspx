<%@ Page Title="" Language="C#" MasterPageFile="~/Hr/hr.master" AutoEventWireup="true" CodeFile="OTapprove.aspx.cs" Inherits="Hr_OTapprove" %>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
        ...
        DataKeyNames="OT_requisition_id" CellPadding="4" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="OT_inttime" HeaderText="In Time"  DataFormatString="{0:dd/MM/yyyy}" />
            <asp:BoundField DataField="OT_outtime" HeaderText="Out Time" />
