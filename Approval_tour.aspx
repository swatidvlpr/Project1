<%@ Page Title="" Language="C#" MasterPageFile="~/Hr/hr.master" AutoEventWireup="true" CodeFile="Approval_tour.aspx.cs" Inherits="Hr_Approval_tour" %>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
        ...
        DataKeyNames="tour_id" CellPadding="4" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="In_date" HeaderText="In date"  DataFormatString="{0:dd/MM/yyyy}" />
            <asp:BoundField DataField="intime" HeaderText="In time" />
            <asp:BoundField DataField="tourlocation" HeaderText="Location" />
             <asp:BoundField DataField="buget" HeaderText="Buget" DataFormatString="{0:n}" />           
