<%@ Page Title="" Language="C#" MasterPageFile="~/DSR/DSR.master" AutoEventWireup="true" CodeFile="Followupstatusmaster.aspx.cs" Inherits="DSR_Followupstatusmaster_aspx" %>
...
<div class="forms" data-example-id="form-validation-states">
    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
        <div class="form-title">
							<h4>Followup Status Master :</h4>
		</div>
         <div class="form-body" id="form">
  <div class="col-md-6 form-group">
    <label >Followup Status Name</label>
      <asp:TextBox ID="txtfollowstatus" runat="server" CssClass="form-control"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="txtfollowstatus" ErrorMessage="Enter follow status name" ValidationGroup="a"></asp:RequiredFieldValidator>
  </div>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"  >
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        DataKeyNames="Followupstatus_id" CellPadding="4" ForeColor="#333333" 
