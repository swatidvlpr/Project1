...
public partial class DSR_Delivery_search : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //                        else
        //                        {
        //                            gl.query("SELECT dbo.companymaster.companyname, dbo.Categorymaster.Categorynm, dbo.Delivery_challan_add.Modelnm, dbo.Delivery_challan_add.Model_no,dbo.Delivery_challan_add.Date, dbo.Delivery_challan_add.Order_no, dbo.Delivery_challan_add.Challlan_no, dbo.Delivery_challan_add.Address,dbo.Delivery_challan_add.Email_id, dbo.Delivery_challan_add.Mobile_no, dbo.Delivery_challan_add.Customer_name, dbo.Delivery_challan_add.Customer_id,dbo.Delivery_challan_add.Challan_id, dbo.Delivery_challan_add.Hirepurchase_lease_hypothecated_with_ms, dbo.Delivery_challan_add.Engine_no, dbo.Delivery_challan_add.Chassis_no, dbo.Delivery_challan_add.Ingnition_key_no, dbo.Delivery_challan_add.Battery_make,dbo.Delivery_challan_add. Batteryno, dbo.Delivery_challan_add.Tyremake FROM  dbo.Delivery_challan_add INNER JOIN dbo.companymaster ON dbo.Delivery_challan_add.Company_id = dbo.companymaster.company_id INNER JOIN dbo.Categorymaster ON dbo.Delivery_challan_add.Category_id = dbo.Categorymaster.Category_id WHERE dbo.Delivery_challan_add.Model_no ='" + ddlmodel.SelectedValue + "'");
        //                            GridView1.DataSource = gl.ds;
        //                            GridView1.DataBind();
        //                        }
        //                    }
        ...
        //            else
        //            {
        //                gl.query("SELECT dbo.companymaster.companyname, dbo.Categorymaster.Categorynm, dbo.Delivery_challan_add.Modelnm, dbo.Delivery_challan_add.Model_no,dbo.Delivery_challan_add.Date, dbo.Delivery_challan_add.Order_no, dbo.Delivery_challan_add.Challlan_no, dbo.Delivery_challan_add.Address,dbo.Delivery_challan_add.Email_id, dbo.Delivery_challan_add.Mobile_no, dbo.Delivery_challan_add.Customer_name, dbo.Delivery_challan_add.Customer_id,dbo.Delivery_challan_add.Challan_id, dbo.Delivery_challan_add.Hirepurchase_lease_hypothecated_with_ms, dbo.Delivery_challan_add.Engine_no, dbo.Delivery_challan_add.Chassis_no, dbo.Delivery_challan_add.Ingnition_key_no, dbo.Delivery_challan_add.Battery_make,dbo.Delivery_challan_add. Batteryno, dbo.Delivery_challan_add.Tyremake FROM  dbo.Delivery_challan_add INNER JOIN dbo.companymaster ON dbo.Delivery_challan_add.Company_id = dbo.companymaster.company_id INNER JOIN dbo.Categorymaster ON dbo.Delivery_challan_add.Category_id = dbo.Categorymaster.Category_id WHERE dbo.companymaster.company_id ='" + ddlcompany.SelectedValue + "'");
        //                GridView1.DataSource = gl.ds;
        //                GridView1.DataBind();
        //            }
        //        }
