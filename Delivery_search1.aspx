<%@ Page Title="" Language="C#" MasterPageFile="~/DSR/DSR.master" AutoEventWireup="true" CodeFile="Delivery_search1.aspx.cs" Inherits="DSR_Delivery_search" %>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
        ...
        <Columns>
                    <asp:BoundField DataField="Customer_name" HeaderText="Customer" />
                        ...
                        <asp:BoundField DataField="Challlan_no" HeaderText="Challlan no" />
